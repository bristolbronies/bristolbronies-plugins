...
if(function_exists("register_field_group"))
{
	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				...
				'label' => 'Is this person a current Bristol Bronies staff member?',
				'name' => 'runner_staff',
				'type' => 'checkbox',
				'choices' => array (
					'true' => 'Yes, this person is a current Bristol Bronies staff member.',
				),
				'default_value' => '',
				'layout' => 'vertical',
			),
	...
	register_field_group(array (
		...
		'fields' => array (
			...
			array (
				'key' => 'field_53300f57d84e1',
				'label' => 'Facebook account',
				'name' => 'runner_facebook',
				'type' => 'text',
				'instructions' => 'Facebook username',
				'default_value' => '',
				'placeholder' => '',
			...
			array (
				...
				'name' => 'runner_links',
				'type' => 'textarea',
				'instructions' => 'URLs for social media or other websites you want to show off. Recognised formats (e.g. for Facebook, Twitter) will be converted into friendly formats. Other URLs will be visually shortened to just the domain name. ',
				'default_value' => '',
				'placeholder' => '',
				'maxlength' => '',
				'rows' => 5,
